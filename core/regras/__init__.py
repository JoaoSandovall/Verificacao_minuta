...
from .regras_corpo import auditar_preambulo, auditar_numeracao_artigos, auditar_pontuacao_incisos, auditar_uso_siglas
from .regras_rodape import auditar_assinatura, auditar_fecho_vigencia
from .regras_anexo import auditar_anexo  # <-- ADICIONE ESTA LINHA
...
TODAS_AS_AUDITORIAS = {
    ...
    "Anexo": auditar_anexo, # <-- ADICIONE ESTA LINHA
}